    ...
    <section class="pt-32 pb-20 min-h-screen bg-gradient-to-br from-blue-50 via-white to-blue-50 relative overflow-hidden">
        ...
        <div class="relative container mx-auto px-6 lg:px-20">
            ...
            <div class="text-center mb-16">
                ...
                <div id="total-mahasiswa" class="mt-4 inline-block px-6 py-2 bg-blue-100 text-blue-800 rounded-full font-semibold"></div>
            </div>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', () => {
            ...
            fetch(`/api/prodi/${id}`)
                ...
                .then(data => {
                    prodiInfo.innerHTML = `
                        <span class="bg-gradient-to-r from-blue-600 to-blue-800 bg-clip-text text-transparent">
                            ${data.nama ?? 'Prodi Tidak Ditemukan'}
                        </span>`;
                    ...
                    if (data.mahasiswa && data.mahasiswa.length > 0) {
                        ...
                        list.innerHTML = `
                            <div class="col-span-full flex flex-col justify-center items-center h-[60vh] text-center">
        ...
        function renderMahasiswa(mahasiswaArray) {
            ...
            if (mahasiswaArray.length === 0) {
                list.innerHTML = `
                    <div class="col-span-full flex justify-center items-center h-[60vh] text-gray-500 text-lg">
